...
IF (YDTPTRSLB2%MSLB2DBBC1 > 0) THEN
  ...
  CALL FIELD_NEW (SELF%F_DBBC1, DATA=SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DBBC1 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2DPHI1 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2DPHI1
  CALL FIELD_NEW (SELF%F_DPHI1, DATA=SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_DPHI1 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2USI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2USI
  CALL FIELD_NEW (SELF%F_USI, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_USI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VSI
  CALL FIELD_NEW (SELF%F_VSI, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2TSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2TSI
  CALL FIELD_NEW (SELF%F_TSI, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_TSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2PDSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2PDSI
  CALL FIELD_NEW (SELF%F_PDSI, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_PDSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VDSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VDSI
  CALL FIELD_NEW (SELF%F_VDSI, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VDSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2SPSI > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2SPSI
  CALL FIELD_NEW (SELF%F_SPSI, DATA=SELF%ZDATA (:, JFLD, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_SPSI => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VVEL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VVEL
  CALL FIELD_NEW (SELF%F_VVEL, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VVEL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2URL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2URL
  CALL FIELD_NEW (SELF%F_URL, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_URL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VRL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VRL
  CALL FIELD_NEW (SELF%F_VRL, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VRL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2WRL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2WRL
  CALL FIELD_NEW (SELF%F_WRL, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_WRL => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2URL5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2URL5
  CALL FIELD_NEW (SELF%F_URL5, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_URL5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VRL5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VRL5
  CALL FIELD_NEW (SELF%F_VRL5, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VRL5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2WRL5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2WRL5
  CALL FIELD_NEW (SELF%F_WRL5, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_WRL5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2USI5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2USI5
  CALL FIELD_NEW (SELF%F_USI5, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_USI5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2VSI5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2VSI5
  CALL FIELD_NEW (SELF%F_VSI5, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_VSI5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2U15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2U15
  CALL FIELD_NEW (SELF%F_U15, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_U15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2V15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2V15
  CALL FIELD_NEW (SELF%F_V15, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_V15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2T15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2T15
  CALL FIELD_NEW (SELF%F_T15, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_T15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2Q15 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2Q15
  CALL FIELD_NEW (SELF%F_Q15, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_Q15 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPA > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPA
  CALL FIELD_NEW (SELF%F_KAPPA, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPA => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAT > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAT
  CALL FIELD_NEW (SELF%F_KAPPAT, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAT => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAM > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAM
  CALL FIELD_NEW (SELF%F_KAPPAM, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAM => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAH > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAH
  CALL FIELD_NEW (SELF%F_KAPPAH, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAH => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPA5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPA5
  CALL FIELD_NEW (SELF%F_KAPPA5, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPA5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2KAPPAT5 > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2KAPPAT5
  CALL FIELD_NEW (SELF%F_KAPPAT5, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_KAPPAT5 => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2GWF > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2GWF
  CALL FIELD_NEW (SELF%F_GWF, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GWF => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2GDW > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2GDW
  CALL FIELD_NEW (SELF%F_GDW, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GDW => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2GWS > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2GWS
  CALL FIELD_NEW (SELF%F_GWS, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_GWS => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISU > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2STDDISU
  CALL FIELD_NEW (SELF%F_STDDISU, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_STDDISU => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISV > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2STDDISV
  CALL FIELD_NEW (SELF%F_STDDISV, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_STDDISV => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2STDDISW > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2STDDISW
  CALL FIELD_NEW (SELF%F_STDDISW, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_STDDISW => NULL ()
ENDIF
IF (YDTPTRSLB2%MSLB2ZRL > 0) THEN
  JFLD = YDTPTRSLB2%MSLB2ZRL
  CALL FIELD_NEW (SELF%F_ZRL, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV-1, :), PERSISTENT=LLPERSISTENT)
ELSE
  SELF%F_ZRL => NULL ()
ENDIF
