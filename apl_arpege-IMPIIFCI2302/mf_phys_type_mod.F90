...
IF (LLMF_PHYS) THEN
  IF (PRESENT (PEMTD)) THEN
      CALL FIELD_NEW (SELF%F_EMTD, DATA=PEMTD, LBOUNDS=[1, 0, IBLKMIN])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PEMTU)) THEN
      CALL FIELD_NEW (SELF%F_EMTU, DATA=PEMTU, LBOUNDS=[1, 0, IBLKMIN])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PTRSW)) THEN
      CALL FIELD_NEW (SELF%F_TRSW, DATA=PTRSW, LBOUNDS=[1, 0, IBLKMIN])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PRMOON)) THEN
      CALL FIELD_NEW (SELF%F_RMOON, DATA=PRMOON, LBOUNDS=[1, IBLKMIN])
  ENDIF
ENDIF
