...
IF (YDTPTRSLB1%MSLB1U9 > 0) THEN
  ...
  CALL FIELD_NEW (SELF%U9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%U9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9
  CALL FIELD_NEW (SELF%V9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%V9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9
  CALL FIELD_NEW (SELF%T9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%T9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9
  CALL FIELD_NEW (SELF%PD9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%PD9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9
  CALL FIELD_NEW (SELF%VD9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VD9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1NHX9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1NHX9
  CALL FIELD_NEW (SELF%NHX9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%NHX9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR0
  CALL FIELD_NEW (SELF%UR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%UR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR0
  CALL FIELD_NEW (SELF%VR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR0
  CALL FIELD_NEW (SELF%ZR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%ZR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WR0
  CALL FIELD_NEW (SELF%WR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%WR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR00
  CALL FIELD_NEW (SELF%UR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%UR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR00
  CALL FIELD_NEW (SELF%VR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR00
  CALL FIELD_NEW (SELF%ZR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%ZR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WR00
  CALL FIELD_NEW (SELF%WR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%WR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WRA > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WRA
  CALL FIELD_NEW (SELF%WRA%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%WRA%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR9
  CALL FIELD_NEW (SELF%UR9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%UR9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR9
  CALL FIELD_NEW (SELF%VR9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VR9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1DBBC9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1DBBC9
  CALL FIELD_NEW (SELF%DBBC9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%DBBC9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1DPHI9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1DPHI9
  CALL FIELD_NEW (SELF%DPHI9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%DPHI9%F_P => NULL ()
ENDIF
...
IF (YDTPTRSLB1%MSLB1U0 > 0) THEN
  ...
  CALL FIELD_NEW (SELF%U0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%U0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V0
  CALL FIELD_NEW (SELF%V0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%V0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T0
  CALL FIELD_NEW (SELF%T0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%T0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD0
  CALL FIELD_NEW (SELF%PD0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%PD0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD0
  CALL FIELD_NEW (SELF%VD0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VD0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9
  CALL FIELD_NEW (SELF%C9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%C9%F_P => NULL ()
ENDIF
...
IF (YDTPTRSLB1%MSLB1C0 > 0) THEN
  ...
  CALL FIELD_NEW (SELF%C0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%C0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UP9
  CALL FIELD_NEW (SELF%UP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%UP9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VP9
  CALL FIELD_NEW (SELF%VP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VP9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1TP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1TP9
  CALL FIELD_NEW (SELF%TP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%TP9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1U9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9_SI
  CALL FIELD_NEW (SELF%U9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%U9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9_SI
  CALL FIELD_NEW (SELF%V9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%V9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9_SI
  CALL FIELD_NEW (SELF%T9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%T9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9_SI
  CALL FIELD_NEW (SELF%PD9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%PD9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9_SI
  CALL FIELD_NEW (SELF%VD9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VD9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9_SI
  CALL FIELD_NEW (SELF%C9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%C9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UF9
  CALL FIELD_NEW (SELF%UF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%UF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VF9
  CALL FIELD_NEW (SELF%VF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1TF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1TF9
  CALL FIELD_NEW (SELF%TF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%TF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VDF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VDF9
  CALL FIELD_NEW (SELF%VDF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VDF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1U9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9_NL
  CALL FIELD_NEW (SELF%U9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%U9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9_NL
  CALL FIELD_NEW (SELF%V9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%V9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9_NL
  CALL FIELD_NEW (SELF%T9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%T9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9_NL
  CALL FIELD_NEW (SELF%PD9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%PD9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9_NL
  CALL FIELD_NEW (SELF%VD9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%VD9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9_NL
  CALL FIELD_NEW (SELF%C9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%C9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR9
  CALL FIELD_NEW (SELF%ZR9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%ZR9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1Z9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1Z9
  CALL FIELD_NEW (SELF%Z9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%Z9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1Z0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1Z0
  CALL FIELD_NEW (SELF%Z0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%Z0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZP9
  CALL FIELD_NEW (SELF%ZP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  SELF%ZP9%F_P => NULL ()
ENDIF
...
IF (YDGFC%MP_SL1 > 0 .AND. YDGFC%MP1 > 0) THEN
  ...
  CALL FIELD_NEW (YDF3D%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  YDF3D%F_P => NULL ()
ENDIF
...
IF ((YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) .AND. YDGFC%MP_SL1 > 0 .AND. YDGFC%MP1 > 0)&
  ...
  CALL FIELD_NEW (YDF3D%F_P_F, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  YDF3D%F_P_F => NULL ()
ENDIF
...
IF (YDTPTRSLB1%MSLB1GFLSPF9 >= 0 .AND. YDGFC%MP_SPL > 0 .AND. YDGFC%MP1 > 0) THEN
  ...
  CALL FIELD_NEW (YDF3D%F_P_SPF, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  YDF3D%F_P_SPF => NULL ()
ENDIF
...
IF (YDGFC%MP_SPL > 0 .AND. YDGFC%MP1 > 0) THEN
  ...
  CALL FIELD_NEW (YDF3D%F_P_SP, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  YDF3D%F_P_SP => NULL ()
ENDIF
...
IF (YDGFC%LPHY) THEN
  ...
  CALL FIELD_NEW (YDF3D%F_P_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0, 1])
ELSE
  YDF3D%F_P_P => NULL ()
ENDIF
...
IF (ASSOCIATED (YDF2D%F_P)) THEN
  CALL YDF2D%F_P%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF2D%F_P_F)) THEN
  CALL YDF2D%F_P_F%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF2D%F_P_SPF)) THEN
  CALL YDF2D%F_P_SPF%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF2D%F_P_SP)) THEN
  CALL YDF2D%F_P_SP%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF2D%F_P_P)) THEN
  CALL YDF2D%F_P_P%SYNC_HOST_RDWR
ENDIF
...
IF (ASSOCIATED (YDF3D%F_P)) THEN
  CALL YDF3D%F_P%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF3D%F_P_F)) THEN
  CALL YDF3D%F_P_F%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF3D%F_P_SPF)) THEN
  CALL YDF3D%F_P_SPF%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF3D%F_P_SP)) THEN
  CALL YDF3D%F_P_SP%SYNC_HOST_RDWR
ENDIF
IF (ASSOCIATED (YDF3D%F_P_P)) THEN
  CALL YDF3D%F_P_P%SYNC_HOST_RDWR
ENDIF
...
IF (YDTPTRSLB1%MSLB1U9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9
  CALL FIELD_NEW (SELF%U9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%U9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9
  CALL FIELD_NEW (SELF%V9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%V9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9
  CALL FIELD_NEW (SELF%T9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%T9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9
  CALL FIELD_NEW (SELF%PD9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%PD9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9
  CALL FIELD_NEW (SELF%VD9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VD9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1NHX9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1NHX9
  CALL FIELD_NEW (SELF%NHX9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%NHX9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR0
  CALL FIELD_NEW (SELF%UR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%UR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR0
  CALL FIELD_NEW (SELF%VR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR0
  CALL FIELD_NEW (SELF%ZR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%ZR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WR0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WR0
  CALL FIELD_NEW (SELF%WR0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%WR0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR00
  CALL FIELD_NEW (SELF%UR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%UR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR00
  CALL FIELD_NEW (SELF%VR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR00
  CALL FIELD_NEW (SELF%ZR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%ZR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WR00 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WR00
  CALL FIELD_NEW (SELF%WR00%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%WR00%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1WRA > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1WRA
  CALL FIELD_NEW (SELF%WRA%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%WRA%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UR9
  CALL FIELD_NEW (SELF%UR9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%UR9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VR9
  CALL FIELD_NEW (SELF%VR9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VR9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1DBBC9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1DBBC9
  CALL FIELD_NEW (SELF%DBBC9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%DBBC9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1DPHI9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1DPHI9
  CALL FIELD_NEW (SELF%DPHI9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%DPHI9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1GWS9 > 0) THEN
...
IF (YDTPTRSLB1%MSLB1U0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U0
  CALL FIELD_NEW (SELF%U0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%U0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V0
  CALL FIELD_NEW (SELF%V0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%V0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T0
  CALL FIELD_NEW (SELF%T0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%T0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD0
  CALL FIELD_NEW (SELF%PD0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%PD0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD0
  CALL FIELD_NEW (SELF%VD0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VD0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9
  CALL FIELD_NEW (SELF%C9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%C9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1SP9 > 0) THEN
...
IF (YDTPTRSLB1%MSLB1C0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C0
  CALL FIELD_NEW (SELF%C0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%C0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UP9
  CALL FIELD_NEW (SELF%UP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%UP9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VP9
  CALL FIELD_NEW (SELF%VP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VP9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1TP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1TP9
  CALL FIELD_NEW (SELF%TP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%TP9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1U9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9_SI
  CALL FIELD_NEW (SELF%U9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%U9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9_SI
  CALL FIELD_NEW (SELF%V9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%V9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9_SI
  CALL FIELD_NEW (SELF%T9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%T9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9_SI
  CALL FIELD_NEW (SELF%PD9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%PD9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9_SI
  CALL FIELD_NEW (SELF%VD9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VD9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9_SI > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9_SI
  CALL FIELD_NEW (SELF%C9_SI%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%C9_SI%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1UF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1UF9
  CALL FIELD_NEW (SELF%UF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%UF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VF9
  CALL FIELD_NEW (SELF%VF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1TF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1TF9
  CALL FIELD_NEW (SELF%TF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%TF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VDF9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VDF9
  CALL FIELD_NEW (SELF%VDF9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VDF9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1U9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1U9_NL
  CALL FIELD_NEW (SELF%U9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%U9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1V9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1V9_NL
  CALL FIELD_NEW (SELF%V9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%V9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1T9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1T9_NL
  CALL FIELD_NEW (SELF%T9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%T9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1PD9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1PD9_NL
  CALL FIELD_NEW (SELF%PD9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%PD9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1VD9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1VD9_NL
  CALL FIELD_NEW (SELF%VD9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%VD9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1C9_NL > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1C9_NL
  CALL FIELD_NEW (SELF%C9_NL%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%C9_NL%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZR9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZR9
  CALL FIELD_NEW (SELF%ZR9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%ZR9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1Z9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1Z9
  CALL FIELD_NEW (SELF%Z9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%Z9%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1Z0 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1Z0
  CALL FIELD_NEW (SELF%Z0%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%Z0%F_P => NULL ()
ENDIF
IF (YDTPTRSLB1%MSLB1ZP9 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1ZP9
  CALL FIELD_NEW (SELF%ZP9%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  SELF%ZP9%F_P => NULL ()
ENDIF
...
IF (YDGFC%MP_SL1 > 0 .AND. YDGFC%MP1 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1GFL9     + (YDGFC%MP_SL1-1)*(NLEV+2)
  CALL FIELD_NEW (YDF3D%F_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  YDF3D%F_P => NULL ()
ENDIF
...
IF ((YDMODEL%YRML_DYN%YRDYN%LSPLTHOIGFL .OR. (YDMODEL%YRML_DYN%YRDYN%NSPLTHOI /= 0)) .AND. YDGFC%MP_SL1 > 0 .AND. YDGFC%MP1 > 0)&
    & THEN
  JFLD = YDTPTRSLB1%MSLB1GFLF9    + (YDGFC%MP_SL1-1)*(NLEV+2)
  CALL FIELD_NEW (YDF3D%F_P_F, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  YDF3D%F_P_F => NULL ()
ENDIF
...
IF (YDTPTRSLB1%MSLB1GFLSPF9 >= 0 .AND. YDGFC%MP_SPL > 0 .AND. YDGFC%MP1 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1GFLSPF9  + (YDGFC%MP_SPL-1)*(NLEV+2)
  CALL FIELD_NEW (YDF3D%F_P_SPF, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  YDF3D%F_P_SPF => NULL ()
ENDIF
...
IF (YDGFC%MP_SPL > 0 .AND. YDGFC%MP1 > 0) THEN
  JFLD = YDTPTRSLB1%MSLB1GFLSP9   + (YDGFC%MP_SPL-1)*(NLEV+2)
  CALL FIELD_NEW (YDF3D%F_P_SP, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  YDF3D%F_P_SP => NULL ()
ENDIF
...
IF (YDGFC%LPHY) THEN
  JFLD = YDTPTRSLB1%MSLB1GFLP9    + (YDGFC%MPSLP -1)*(NLEV+2)
  CALL FIELD_NEW (YDF3D%F_P_P, DATA=SELF%ZDATA (:, JFLD:JFLD+NLEV+1), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0])
ELSE
  YDF3D%F_P_P => NULL ()
ENDIF
...
IF (LHOOK) CALL DR_HOOK ('CPG_SL1B_TYPE_ZERO', 0, ZHOOK_HANDLE)

YDCPG_SL1B%ZVIEW = 0._JPRB

IF (LHOOK) CALL DR_HOOK ('CPG_SL1B_TYPE_ZERO', 1, ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK ('CPG_SL1B_TYPE_ZERO_HOST_PARALLEL', 0, ZHOOK_HANDLE)

CALL YDCPG_SL1B%SYNC_HOST

!$OMP PARALLEL DO PRIVATE (JBLK)
DO JBLK = 1, YDCPG_OPTS%KGPBLKS
  YDCPG_SL1B%ZDATA (:,:,JBLK) = 0._JPRB
ENDDO
!$OMP END PARALLEL DO

IF (LHOOK) CALL DR_HOOK ('CPG_SL1B_TYPE_ZERO_HOST_PARALLEL', 1, ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK ('CPG_SL1B_TYPE_ZERO_DEVICE_PARALLEL', 0, ZHOOK_HANDLE)

CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%U9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%V9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%T9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%PD9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VD9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%NHX9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%UR0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VR0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%ZR0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%WR0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%UR00)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VR00)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%ZR00)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%WR00)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%WRA)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%UR9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VR9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%DBBC9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%DPHI9)
CALL CPG_SL1_2D_TYPE_ZERO (YDCPG_SL1B%GWS9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%U0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%V0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%T0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%PD0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VD0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%C9)
CALL CPG_SL1_2D_TYPE_ZERO (YDCPG_SL1B%SP9)
CALL CPG_SL1_2D_TYPE_ZERO (YDCPG_SL1B%SP0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%C0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%UP9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VP9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%TP9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%U9_SI)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%V9_SI)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%T9_SI)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%PD9_SI)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VD9_SI)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%C9_SI)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%UF9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VF9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%TF9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VDF9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%U9_NL)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%V9_NL)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%T9_NL)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%PD9_NL)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%VD9_NL)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%C9_NL)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%ZR9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%Z9)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%Z0)
CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%ZP9)

DO JGFL = 1, SIZE (YDCPG_SL1B%GFL)
  CALL CPG_SL1_3D_TYPE_ZERO (YDCPG_SL1B%GFL (JGFL))
ENDDO

IF (LHOOK) CALL DR_HOOK ('CPG_SL1B_TYPE_ZERO_DEVICE_PARALLEL', 1, ZHOOK_HANDLE)

CONTAINS

SUBROUTINE CPG_SL1_2D_TYPE_ZERO (YDF2D)
...
SUBROUTINE CPG_SL1_3D_TYPE_ZERO (YDF3D)
