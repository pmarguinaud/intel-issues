...
USE FIELD_4RD_DATA_MODULE, ONLY : FIELD_4RD_COPY_INTF
...
TYPE, ABSTRACT, EXTENDS (FIELD_BASIC) :: FIELD_4RD
  ...
  PROCEDURE (FIELD_4RD_COPY_INTF), POINTER, NOPASS :: COPY_FUNC => NULL ()
CONTAINS
...
CONTAINS
  ...
  PROCEDURE, PRIVATE :: CREATE_HOST_DATA => FIELD_4RD_CREATE_HOST_DATA
...
CONTAINS
  ...
  SUBROUTINE FIELD_4RD_WRAPPER_INIT(SELF, DATA, PERSISTENT, LBOUNDS, MAP_DEVPTR, SYNC_ON_FINAL)
USE FIELD_ABORT_MODULE
USE FIELD_DEFAULTS_MODULE
USE FIELD_4RD_DATA_MODULE, ONLY : FIELD_4RD_COPY_FUNC
...
END SUBROUTINE FIELD_4RD_WRAPPER_INIT
  ...
  SUBROUTINE FIELD_4RD_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, PINNED, MAP_DEVPTR)
USE FIELD_ABORT_MODULE
USE FIELD_4RD_DATA_MODULE, ONLY : FIELD_4RD_COPY_FUNC
...
END SUBROUTINE FIELD_4RD_OWNER_INIT
  ...
  SUBROUTINE FIELD_4RD_CREATE_HOST_DATA (SELF)

CLASS(FIELD_4RD_OWNER) :: SELF


END SUBROUTINE FIELD_4RD_CREATE_HOST_DATA
