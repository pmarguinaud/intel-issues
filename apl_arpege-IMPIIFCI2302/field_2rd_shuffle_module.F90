...
FUNCTION PAIR_FIELD_2RD_GATHER_DEVICE_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
...
END FUNCTION PAIR_FIELD_2RD_GATHER_DEVICE_DATA_RDONLY


FUNCTION PAIR_FIELD_2RD_GATHER_DEVICE_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
TYPE (FIELD_2RD_SHUFFLE_PAIR), POINTER              :: YDPAIR
LOGICAL,                                   INTENT (IN) :: LDNULL, LDFULL
INTEGER (KIND=JPIM),                       INTENT (IN) :: KLON, KGPBLKS
CLASS (FIELD_3IM),                POINTER              :: YDFINDS
...
END FUNCTION PAIR_FIELD_2RD_GATHER_DEVICE_DATA_RDWR


FUNCTION PAIR_FIELD_2RD_GATHER_HOST_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
TYPE (FIELD_2RD_SHUFFLE_PAIR), POINTER              :: YDPAIR
LOGICAL,                                   INTENT (IN) :: LDNULL, LDFULL
INTEGER (KIND=JPIM),                       INTENT (IN) :: KLON, KGPBLKS
CLASS (FIELD_3IM),                POINTER              :: YDFINDS
...
END FUNCTION PAIR_FIELD_2RD_GATHER_HOST_DATA_RDONLY


FUNCTION PAIR_FIELD_2RD_GATHER_HOST_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
TYPE (FIELD_2RD_SHUFFLE_PAIR), POINTER              :: YDPAIR
LOGICAL,                                   INTENT (IN) :: LDNULL, LDFULL
INTEGER (KIND=JPIM),                       INTENT (IN) :: KLON, KGPBLKS
CLASS (FIELD_3IM),                POINTER              :: YDFINDS
...
END FUNCTION PAIR_FIELD_2RD_GATHER_HOST_DATA_RDWR
