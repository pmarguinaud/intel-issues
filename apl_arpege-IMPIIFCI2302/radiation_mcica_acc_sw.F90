...
#include "radiation_delta_eddington.h"
  ...
  subroutine solver_mcica_acc_sw_GPU(nlev,istartcol,iendcol, &
...
end subroutine solver_mcica_acc_sw_GPU

  subroutine solver_mcica_acc_sw_CPU(nlev,istartcol,iendcol, &
&  config, single_level, cloud, &
&  od, ssa, g, od_cloud, ssa_cloud, g_cloud, &
&  albedo_direct, albedo_diffuse, incoming_sw, &
&  flux)
...
end subroutine solver_mcica_acc_sw_CPU
