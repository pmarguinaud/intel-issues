...
SUBROUTINE FIELD_1RD_NEW_WRAPPER (FIELD_PTR, LBOUNDS, PERSISTENT, DATA, MAP_DEVPTR, SYNC_ON_FINAL)
CLASS(FIELD_1RD), POINTER :: FIELD_PTR
...
SUBROUTINE FIELD_1RD_RESIZE (FIELD_PTR, UBOUNDS, LBOUNDS, PERSISTENT)
CLASS(FIELD_1RD), POINTER :: FIELD_PTR
INTEGER(KIND=JPIM), INTENT(IN) :: UBOUNDS (1)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: LBOUNDS (1)
LOGICAL, OPTIONAL, INTENT(IN) :: PERSISTENT
