...
FUNCTION PAIR_FIELD_5LM_GATHER_DEVICE_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
...
END FUNCTION PAIR_FIELD_5LM_GATHER_DEVICE_DATA_RDONLY


FUNCTION PAIR_FIELD_5LM_GATHER_DEVICE_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
TYPE (FIELD_5LM_SHUFFLE_PAIR), POINTER              :: YDPAIR
LOGICAL,                                   INTENT (IN) :: LDNULL, LDFULL
INTEGER (KIND=JPIM),                       INTENT (IN) :: KLON, KGPBLKS
CLASS (FIELD_3IM),                POINTER              :: YDFINDS
...
END FUNCTION PAIR_FIELD_5LM_GATHER_DEVICE_DATA_RDWR


FUNCTION PAIR_FIELD_5LM_GATHER_HOST_DATA_RDONLY (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
TYPE (FIELD_5LM_SHUFFLE_PAIR), POINTER              :: YDPAIR
LOGICAL,                                   INTENT (IN) :: LDNULL, LDFULL
INTEGER (KIND=JPIM),                       INTENT (IN) :: KLON, KGPBLKS
CLASS (FIELD_3IM),                POINTER              :: YDFINDS
...
END FUNCTION PAIR_FIELD_5LM_GATHER_HOST_DATA_RDONLY


FUNCTION PAIR_FIELD_5LM_GATHER_HOST_DATA_RDWR (YDPAIR, LDNULL, LDFULL, KLON, KGPBLKS, YDFINDS, YLF) RESULT (PTR)
TYPE (FIELD_5LM_SHUFFLE_PAIR), POINTER              :: YDPAIR
LOGICAL,                                   INTENT (IN) :: LDNULL, LDFULL
INTEGER (KIND=JPIM),                       INTENT (IN) :: KLON, KGPBLKS
CLASS (FIELD_3IM),                POINTER              :: YDFINDS
...
END FUNCTION PAIR_FIELD_5LM_GATHER_HOST_DATA_RDWR
