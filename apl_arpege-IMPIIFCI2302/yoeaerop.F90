...
REAL(KIND=JPRB) :: ALFS_SS15(15,14,3), ASYS_SS15(15,14,3), OMGS_SS15(15,14,3)
REAL(KIND=JPRB) :: ALFS_SU(12,14)  , ASYS_SU(12,14)  , OMGS_SU(12,14)
REAL(KIND=JPRB) :: ALFS_NI(12,14,2), ASYS_NI(12,14,2), OMGS_NI(12,14,2)
REAL(KIND=JPRB) :: ALFS_AM(12,14)  , ASYS_AM(12,14)  , OMGS_AM(12,14)
...
REAL(KIND=JPRB) :: ALFL_SS15(15,16,3), ASYL_SS15(15,16,3), OMGL_SS15(15,16,3)
REAL(KIND=JPRB) :: ALFL_SU(12,16)  , ASYL_SU(12,16)  , OMGL_SU(12,16)
REAL(KIND=JPRB) :: ALFL_NI(12,16,2), ASYL_NI(12,16,2), OMGL_NI(12,16,2)
REAL(KIND=JPRB) :: ALFL_AM(12,16)  , ASYL_AM(12,16)  , OMGL_AM(12,16)
