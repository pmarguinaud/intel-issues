...
INTERFACE FIELD_RESIZE
  MODULE PROCEDURE FIELD_3IM_RESIZE
...
SUBROUTINE FIELD_3IM_NEW_WRAPPER (FIELD_PTR, LBOUNDS, PERSISTENT, DATA, MAP_DEVPTR, SYNC_ON_FINAL)
CLASS(FIELD_3IM), POINTER :: FIELD_PTR
...
SUBROUTINE FIELD_3IM_NEW_GANG_WRAPPER (FIELD_PTR, CHILDREN, LBOUNDS, PERSISTENT, DATA, SYNC_ON_FINAL)
CLASS(FIELD_3IM), POINTER :: FIELD_PTR
...
SUBROUTINE FIELD_3IM_NEW_GANG_OWNER (FIELD_PTR, CHILDREN, UBOUNDS, LBOUNDS, PERSISTENT, DELAYED, INIT_VALUE)
CLASS(FIELD_3IM), POINTER :: FIELD_PTR
TYPE(FIELD_2IM_PTR), ALLOCATABLE :: CHILDREN (:)
INTEGER(KIND=JPIM), INTENT(IN) :: UBOUNDS (3)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: LBOUNDS (3)
...
SUBROUTINE FIELD_3IM_RESIZE (FIELD_PTR, UBOUNDS, LBOUNDS, PERSISTENT)
CLASS(FIELD_3IM), POINTER :: FIELD_PTR
INTEGER(KIND=JPIM), INTENT(IN) :: UBOUNDS (3)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: LBOUNDS (3)
LOGICAL, OPTIONAL, INTENT(IN) :: PERSISTENT

END SUBROUTINE FIELD_3IM_RESIZE
