...
#include "apl_arpege_part0.intfb.h"
...
& PAPHIF=> YDMF_PHYS_BASE_STATE%YCPG_DYN%PHIF, PAPHI=> YDMF_PHYS_BASE_STATE%YCPG_DYN%PHI, &
...
CALL APL_ARPEGE_PART0(YDMF_PHYS_BASE_STATE, YDMF_PHYS_NEXT_STATE, YDGEOMETRY, YDCPG_BNDS, YDCPG_OPTS,           &
& YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDMF_PHYS, YDCPG_DYN0, YDMF_PHYS_SURF, YDCPG_SL2, YDVARS, YDMODEL, YDDDH, &
& YDPHYSMWAVE, IMOC_CLPH, ZDSA_C1, ZDSA_C2, ZDSA_CPS, ZDSA_LHS, ZDSA_RS, ZFLU_CDN, ZFLU_CD, ZFLU_CHN, ZFLU_CH,  &
& ZFLU_EMIS, ZFLU_FEVI, ZFLU_NEIJ, ZFLU_QSATS, ZFLU_QSAT, ZFLU_VEG, ZMSC_FRMQ, ZFCHQ, ZMSC_LH, ZMSC_LSCPE,      &
& ZMSC_QW, ZMSC_TW, ZPFL_FEFB1, ZPFL_FEFB2, ZPFL_FEFB3, ZPFL_FPLCH, ZPFL_FPLSH, ZPFL_FTKEI, ZPFL_FTKE,          &
& ZRDG_CVGQ, ZRDG_CVGT, ZRDG_LCVQ, ZRDG_MU0LU, ZRDG_MU0M, ZRDG_MU0N, ZRDG_MU0, ZRDG_SOLO, ZSAV_DDAL, ZSAV_DDOM, &
& ZSAV_ENTCH, ZSAV_FHPS, ZSAV_GZ0F, ZSAV_GZ0HF, ZSAV_HV, ZSAV_PBLH, ZSAV_QSH , ZSAV_UDAL, ZSAV_UDGRO, ZSAV_UDOM,&
& ZSAV_UNEBH, ZQCO2)
...
!DEC$ IVDEP
DO JLON = KIDIA, KFDIA
  IF(.NOT.LMSE)YDMF_PHYS%OUT%FRTHDS(JLON)=YDMF_PHYS%OUT%FRTH(JLON,KFLEVG,1)/ZFLU_EMIS(JLON)+&
