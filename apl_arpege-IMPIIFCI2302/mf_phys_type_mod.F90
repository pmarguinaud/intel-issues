...
CALL FIELD_NEW (SELF%F_DIFCQ, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFCQL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFCQN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFCS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFTQ, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFTQL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFTQN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFTS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_EDR, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCCQL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCCQN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCSQL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCSQN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCQLNG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCQNNG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCQGNG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCQNG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLCL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLCN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLCG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLCH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLSL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLSN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLSG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPLSH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPFPSL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPFPSN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPFPSG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPFPCL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPFPCN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPFPCG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPEVPSL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPEVPSN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPEVPSG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPEVPCL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPEVPCN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FPEVPCG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSO, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KTSSG+1,&
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0, 1, 1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRTH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG, YDCPG_OPTS%KTSSG+1,&
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0, 1, 1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRCU, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRCV, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRDU, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRDV, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRTU, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRTV, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRMU, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_STRMV, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFCQLC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIFCQIC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FIMCC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEDQLC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEDQIC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEDQRC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEDQSC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCNEGQLC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCNEGQIC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCNEGQRC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCNEGQSC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRMH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCHOZ, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FDIS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHPSL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHPSN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHPSG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHPCL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHPCN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHPCG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHSCL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHSCN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHSSL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHSSN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FHSSG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEPFP, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCMPCQ, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCMPSN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCMPSL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSOC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, 1,                REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0, &
    &               1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRTHC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, 1,                REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0, &
    &               1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCHSP, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%YRSURF_DIMS%YSP_SBD%NLEVS,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCLL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KTSSG+1,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCLN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KTSSG+1,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KTSSG+1,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEVL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KTSSG+1,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEVN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KTSSG+1,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FEVV, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FLWSP, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FTR, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],      &
    &                                         PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSODS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSOPS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSDNI, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSGNI, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRTHDS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FONTE, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FGEL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FGELS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_ALB, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],      &
    &                                         PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_GZ0, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],      &
    &                                         PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_GZ0H, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_RUISL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_RUISP, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_RUISS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSOPT, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FRSOLU, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_QCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_TCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_UCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_VCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_NUCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_NVCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_RHCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_MRT, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],      &
    &                                         PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CLCH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CLCM, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CLCL, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CLCC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CLPH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CLPHMF, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_VMAXTH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_VEIN, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DRNSHF, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CAPE, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CTOP, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_MOCON, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_UGST, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_VGST, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],     &
    &                                          PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CT, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],       &
    &                                        PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_TENDU, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_TENDV, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,                REGISTRY%GEOM%YRDIM%NGPBLKS],&
    & LBOUNDS=[1, 1,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCQRNG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FCQSNG, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA, YDCPG_OPTS%KFLEVG,               &
    & REGISTRY%GEOM%YRDIM%NGPBLKS], LBOUNDS=[1, 0,                1], PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIAGH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_VISICLD, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],  &
    &                                             PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_FLASH, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_VISIHYD, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],  &
    &                                             PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_MXCLWC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_LOADSNOW, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS], &
    &                                              PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_LOADICE, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],  &
    &                                             PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_DIAMACCR, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS], &
    &                                              PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_PCPWSNOW, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS], &
    &                                              PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_PCPICE, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_TPWCLS, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],   &
    &                                            PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_CUCONVCA, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS], &
    &                                              PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_NLCONVCA, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS], &
    &                                              PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_SIC, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],      &
    &                                         PERSISTENT=PERSISTENT)

CALL FIELD_NEW (SELF%F_SNWDE, UBOUNDS=[REGISTRY%GEOM%YRDIM%NPROMA,                               REGISTRY%GEOM%YRDIM%NGPBLKS],    &
    &                                           PERSISTENT=PERSISTENT)
...
IF (LLMF_PHYS) THEN
  IF (PRESENT (PGDEOSI)) THEN
      CALL FIELD_NEW (SELF%F_GDEOSI, DATA=PGDEOSI, LBOUNDS=[1, 1, 1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGUEOSI)) THEN
      CALL FIELD_NEW (SELF%F_GUEOSI, DATA=PGUEOSI, LBOUNDS=[1, 1, 1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGMU0)) THEN
      CALL FIELD_NEW (SELF%F_GMU0, DATA=PGMU0, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGMU0_MIN)) THEN
      CALL FIELD_NEW (SELF%F_GMU0_MIN, DATA=PGMU0_MIN, LBOUNDS=[1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGMU0_MAX)) THEN
      CALL FIELD_NEW (SELF%F_GMU0_MAX, DATA=PGMU0_MAX, LBOUNDS=[1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGDEOTI)) THEN
      CALL FIELD_NEW (SELF%F_GDEOTI, DATA=PGDEOTI, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGDEOTI2)) THEN
      CALL FIELD_NEW (SELF%F_GDEOTI2, DATA=PGDEOTI2, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGUEOTI)) THEN
      CALL FIELD_NEW (SELF%F_GUEOTI, DATA=PGUEOTI, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGUEOTI2)) THEN
      CALL FIELD_NEW (SELF%F_GUEOTI2, DATA=PGUEOTI2, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGEOLT)) THEN
      CALL FIELD_NEW (SELF%F_GEOLT, DATA=PGEOLT, LBOUNDS=[1, 1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGEOXT)) THEN
      CALL FIELD_NEW (SELF%F_GEOXT, DATA=PGEOXT, LBOUNDS=[1, 1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGRPROX)) THEN
      CALL FIELD_NEW (SELF%F_GRPROX, DATA=PGRPROX, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGMIXP)) THEN
      CALL FIELD_NEW (SELF%F_GMIXP, DATA=PGMIXP, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGFLUXC)) THEN
      CALL FIELD_NEW (SELF%F_GFLUXC, DATA=PGFLUXC, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PGRSURF)) THEN
      CALL FIELD_NEW (SELF%F_GRSURF, DATA=PGRSURF, LBOUNDS=[1, 1])
  ENDIF
ENDIF
...
IF (LLMF_PHYS) THEN
  IF (PRESENT (PU)) THEN
      CALL FIELD_NEW (SELF%F_U, DATA=PU, LBOUNDS=[1, 1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PV)) THEN
      CALL FIELD_NEW (SELF%F_V, DATA=PV, LBOUNDS=[1, 1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PT)) THEN
      CALL FIELD_NEW (SELF%F_T, DATA=PT, LBOUNDS=[1, 1, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PQ)) THEN
      CALL FIELD_NEW (SELF%F_Q, DATA=PQ, LBOUNDS=[1, 1, 1])
  ENDIF
ENDIF
...
IF (LLMF_PHYS) THEN
  IF (PRESENT (PEMTD)) THEN
      CALL FIELD_NEW (SELF%F_EMTD, DATA=PEMTD, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PEMTU)) THEN
      CALL FIELD_NEW (SELF%F_EMTU, DATA=PEMTU, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PTRSW)) THEN
      CALL FIELD_NEW (SELF%F_TRSW, DATA=PTRSW, LBOUNDS=[1, 0, 1])
  ENDIF
ENDIF

IF (LLMF_PHYS) THEN
  IF (PRESENT (PRMOON)) THEN
      CALL FIELD_NEW (SELF%F_RMOON, DATA=PRMOON, LBOUNDS=[1, 1])
  ENDIF
ENDIF
...
IF (ASSOCIATED (SELF%F_RMOON)) CALL FIELD_DELETE (SELF%F_RMOON) 
IF (ASSOCIATED (SELF%F_TRSW)) CALL FIELD_DELETE (SELF%F_TRSW) 
IF (ASSOCIATED (SELF%F_EMTU)) CALL FIELD_DELETE (SELF%F_EMTU) 
IF (ASSOCIATED (SELF%F_EMTD)) CALL FIELD_DELETE (SELF%F_EMTD) 
