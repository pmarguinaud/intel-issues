...
USE FIELD_3IM_DATA_MODULE, ONLY : FIELD_3IM_COPY_INTF
...
TYPE, ABSTRACT, EXTENDS (FIELD_BASIC) :: FIELD_3IM
  ...
  PROCEDURE (FIELD_3IM_COPY_INTF), POINTER, NOPASS :: COPY_FUNC => NULL ()
CONTAINS

  PROCEDURE :: FINAL => FIELD_3IM_FINAL
  PROCEDURE :: FIELD_3IM_FINAL
  PROCEDURE :: DELETE_DEVICE_DATA => FIELD_3IM_DELETE_DEVICE_DATA
  ...
  PROCEDURE :: GET_DEVICE_DATA => FIELD_3IM_GET_DEVICE_DATA
  PROCEDURE :: GET_HOST_DATA => FIELD_3IM_GET_HOST_DATA
  PROCEDURE, PRIVATE :: FIELD_3IM_GET_HOST_DATA
  PROCEDURE, PRIVATE :: FIELD_3IM_GET_DEVICE_DATA
  PROCEDURE, PRIVATE :: COPY_DATA =>  FIELD_3IM_COPY_DATA
  PROCEDURE :: CREATE_DEVICE_DATA => FIELD_3IM_CREATE_DEVICE_DATA
#ifdef __PGI
  PROCEDURE :: SET_STATUS => FIELD_3IM_SET_STATUS
#endif
END TYPE FIELD_3IM
...
ABSTRACT INTERFACE
  SUBROUTINE GET_DIMS(SELF, LBOUNDS, UBOUNDS)
    USE PARKIND1, ONLY : JPRM, JPRB, JPRD, JPIM, JPLM
    IMPORT ::  FIELD_3IM
    CLASS(FIELD_3IM),               INTENT(IN) :: SELF
...
CONTAINS
  PROCEDURE :: INIT => FIELD_3IM_WRAPPER_INIT
  PROCEDURE :: FINAL => FIELD_3IM_WRAPPER_FINAL
  PROCEDURE :: GET_DIMS => FIELD_3IM_WRAPPER_GET_DIMS
  PROCEDURE :: RESIZE => FIELD_3IM_WRAPPER_RESIZE
...
CONTAINS
  ...
  PROCEDURE, PRIVATE :: CREATE_HOST_DATA => FIELD_3IM_CREATE_HOST_DATA
  PROCEDURE :: GET_HOST_DATA => FIELD_3IM_OWNER_GET_HOST_DATA
  PROCEDURE :: GET_DEVICE_DATA => FIELD_3IM_OWNER_GET_DEVICE_DATA
  PROCEDURE :: GET_DIMS => FIELD_3IM_OWNER_GET_DIMS
  PROCEDURE :: RESIZE => FIELD_3IM_OWNER_RESIZE
...
CONTAINS
  ...
  SUBROUTINE FIELD_3IM_WRAPPER_INIT(SELF, DATA, PERSISTENT, LBOUNDS, MAP_DEVPTR, SYNC_ON_FINAL)
USE FIELD_ABORT_MODULE
USE FIELD_DEFAULTS_MODULE
USE FIELD_3IM_DATA_MODULE, ONLY : FIELD_3IM_COPY_FUNC
...
END SUBROUTINE FIELD_3IM_WRAPPER_INIT

  SUBROUTINE FIELD_3IM_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, PINNED, MAP_DEVPTR)
USE FIELD_ABORT_MODULE
USE FIELD_3IM_DATA_MODULE, ONLY : FIELD_3IM_COPY_FUNC
...
END SUBROUTINE FIELD_3IM_OWNER_INIT
  ...
  SUBROUTINE FIELD_3IM_CREATE_HOST_DATA (SELF)

CLASS(FIELD_3IM_OWNER) :: SELF


END SUBROUTINE FIELD_3IM_CREATE_HOST_DATA
...
END FUNCTION FIELD_3IM_GET_VIEW
  ...
  SUBROUTINE FIELD_3IM_DELETE_DEVICE_DATA(SELF)

CLASS(FIELD_3IM) :: SELF

END SUBROUTINE FIELD_3IM_DELETE_DEVICE_DATA
...
END SUBROUTINE FIELD_3IM_GET_DEVICE_DATA
  ...
  SUBROUTINE FIELD_3IM_OWNER_GET_DEVICE_DATA (SELF, MODE, PTR, QUEUE)
CLASS(FIELD_3IM_OWNER) :: SELF
INTEGER (KIND=JPIM),           INTENT(IN)    :: MODE
INTEGER(KIND=JPIM), POINTER,          INTENT(INOUT) :: PTR(:,:,:)
INTEGER (KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
...
END SUBROUTINE FIELD_3IM_OWNER_GET_DEVICE_DATA
...
END SUBROUTINE FIELD_3IM_SYNC_DEVICE_RDWR
  ...
  SUBROUTINE FIELD_3IM_WRAPPER_GET_DIMS (SELF, LBOUNDS, UBOUNDS)
CLASS(FIELD_3IM_WRAPPER),       INTENT(IN) :: SELF
INTEGER(KIND=JPIM), OPTIONAL, INTENT(OUT) :: LBOUNDS(3)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(OUT) :: UBOUNDS(3)


END SUBROUTINE FIELD_3IM_WRAPPER_GET_DIMS

  SUBROUTINE FIELD_3IM_OWNER_GET_DIMS (SELF, LBOUNDS, UBOUNDS)
CLASS(FIELD_3IM_OWNER),         INTENT(IN) :: SELF
INTEGER(KIND=JPIM), OPTIONAL, INTENT(OUT) :: LBOUNDS(3)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(OUT) :: UBOUNDS(3)


END SUBROUTINE FIELD_3IM_OWNER_GET_DIMS

  SUBROUTINE FIELD_3IM_WRAPPER_RESIZE (SELF, UBOUNDS, LBOUNDS, PERSISTENT)
USE FIELD_ABORT_MODULE
CLASS(FIELD_3IM_WRAPPER),       INTENT(IN) :: SELF
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: UBOUNDS(3)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: LBOUNDS(3)
...
END SUBROUTINE FIELD_3IM_WRAPPER_RESIZE

  SUBROUTINE FIELD_3IM_OWNER_RESIZE (SELF, UBOUNDS, LBOUNDS, PERSISTENT)
CLASS(FIELD_3IM_OWNER),         INTENT(IN) :: SELF
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: UBOUNDS(3)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: LBOUNDS(3)
LOGICAL, OPTIONAL,            INTENT(IN) :: PERSISTENT
...
END SUBROUTINE FIELD_3IM_OWNER_RESIZE

#ifdef __PGI
  SUBROUTINE FIELD_3IM_SET_STATUS (SELF, KSTATUS)
CLASS (FIELD_3IM) :: SELF
INTEGER (KIND=JPIM), INTENT (IN) :: KSTATUS

END SUBROUTINE FIELD_3IM_SET_STATUS
#endif
