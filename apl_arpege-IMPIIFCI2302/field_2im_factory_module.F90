...
SUBROUTINE FIELD_2IM_NEW_WRAPPER (FIELD_PTR, LBOUNDS, PERSISTENT, DATA, MAP_DEVPTR, SYNC_ON_FINAL)
CLASS(FIELD_2IM), POINTER :: FIELD_PTR
...
SUBROUTINE FIELD_2IM_RESIZE (FIELD_PTR, UBOUNDS, LBOUNDS, PERSISTENT)
CLASS(FIELD_2IM), POINTER :: FIELD_PTR
INTEGER(KIND=JPIM), INTENT(IN) :: UBOUNDS (2)
INTEGER(KIND=JPIM), OPTIONAL, INTENT(IN) :: LBOUNDS (2)
LOGICAL, OPTIONAL, INTENT(IN) :: PERSISTENT

END SUBROUTINE FIELD_2IM_RESIZE
