...
CONTAINS
  ...
  SUBROUTINE MF_PHYS_SURF_TYPE_SET9TO0_HOST_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_SG%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_SL%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_RR%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_CL%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_OM%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_EP%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_X2%SET9TO0_HOST_PARALLEL()
    CALL SELF%GSP_CI%SET9TO0_HOST_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET9TO0_HOST_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO9_HOST_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_SG%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_SL%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_RR%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_CL%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_OM%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_EP%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_X2%SET1TO9_HOST_PARALLEL()
    CALL SELF%GSP_CI%SET1TO9_HOST_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO9_HOST_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO0_HOST_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_SG%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_SL%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_RR%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_CL%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_OM%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_EP%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_X2%SET1TO0_HOST_PARALLEL()
    CALL SELF%GSP_CI%SET1TO0_HOST_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO0_HOST_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_SET0TO1_HOST_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_SG%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_SL%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_RR%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_CL%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_OM%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_EP%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_X2%SET0TO1_HOST_PARALLEL()
    CALL SELF%GSP_CI%SET0TO1_HOST_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET0TO1_HOST_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_PHTFILT_HOST_PARALLEL(SELF, YDDYN)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF
    TYPE(TDYN), INTENT(IN) :: YDDYN
  ...
  SUBROUTINE MF_PHYS_SURF_TYPE_SET9TO0_DEVICE_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_SG%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_SL%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_RR%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_CL%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_OM%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_EP%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_X2%SET9TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_CI%SET9TO0_DEVICE_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET9TO0_DEVICE_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO9_DEVICE_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_SG%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_SL%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_RR%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_CL%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_OM%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_EP%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_X2%SET1TO9_DEVICE_PARALLEL()
    CALL SELF%GSP_CI%SET1TO9_DEVICE_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO9_DEVICE_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO0_DEVICE_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_SG%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_SL%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_RR%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_CL%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_OM%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_EP%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_X2%SET1TO0_DEVICE_PARALLEL()
    CALL SELF%GSP_CI%SET1TO0_DEVICE_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET1TO0_DEVICE_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_SET0TO1_DEVICE_PARALLEL(SELF)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF

    CALL SELF%GSP_SB%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_SG%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_SL%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_RR%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_CL%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_OM%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_EP%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_X2%SET0TO1_DEVICE_PARALLEL()
    CALL SELF%GSP_CI%SET0TO1_DEVICE_PARALLEL()
  END SUBROUTINE MF_PHYS_SURF_TYPE_SET0TO1_DEVICE_PARALLEL

  SUBROUTINE MF_PHYS_SURF_TYPE_PHTFILT_DEVICE_PARALLEL(SELF, YDDYN)
    ! Field update operation for timestepping schemes
    CLASS(MF_PHYS_SURF_TYPE) :: SELF
    TYPE(TDYN), INTENT(IN) :: YDDYN
