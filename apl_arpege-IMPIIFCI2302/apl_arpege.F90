...
CALL CPPHINP(YDGEOMETRY, YDMODEL, KIDIA, KFDIA, YDVARS%GEOMETRY%GEMU%T0,  YDVARS%GEOMETRY%GELAM%T0, &
...
& ZCTRSO, ZFLU_EMIS, ZFLU_QSAT, ZQO3, ZQR, ZQS, ZQV, ZRDG_MU0, ZRDG_SOLO, ZRDG_MU0LU, ZRDG_MU0M, &
& ZSFSWDIF, ZSFSWDIR, ZSUDU, ZTENT, ZTRSOD, ZTRSODIF, ZTRSODIR)
