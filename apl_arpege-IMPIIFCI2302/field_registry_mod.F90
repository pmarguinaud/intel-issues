...
! END FUNCTION CREATE_FIELD_EMPTY_4D
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_WRAP_2RB(SELF, NAME, DATA) RESULT(VARIABLE)
    ...
    VARIABLE = VARIABLE_2RB(NAME, LACTIVE=.TRUE.)
    CALL FIELD_NEW (VARIABLE%FT0, DATA=DATA)
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_WRAP_2RD(SELF, NAME, DATA) RESULT(VARIABLE)
    ...
    VARIABLE = VARIABLE_2RD(NAME, LACTIVE=.TRUE.)
    CALL FIELD_NEW (VARIABLE%FT0, DATA=DATA)
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_WRAP_3RB(SELF, NAME, DATA) RESULT(VARIABLE)
    ...
    VARIABLE = VARIABLE_3RB(NAME, LACTIVE=.TRUE.)
    CALL FIELD_NEW (VARIABLE%FT0, DATA=DATA)
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_WRAP_4RB(SELF, NAME, DATA) RESULT(VARIABLE)
    ...
    VARIABLE = VARIABLE_4RB(NAME, LACTIVE=.TRUE.)
    CALL FIELD_NEW (VARIABLE%FT0, DATA=DATA)
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_WRAP_PACKED_2RB(SELF, NAME, DATA, IDX) RESULT(VARIABLE)
    ...
    VARIABLE = VARIABLE_2RB(NAME, LACTIVE=.TRUE.)
    CALL FIELD_NEW (VARIABLE%FT0, DATA=DATA (:,IDX,:))
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_2D_GMV(SELF, NAME, GMV, GMVT1, PT0, PT1, PT9, PPH9, PDL, PDM, &
   &                                             PDL9, PDM9, PPC_PH, PERSISTENT) RESULT(VARIABLE)
    ...
    LOGICAL :: LT0, LT1, LT9, LPH9, LDL, LDM, LDL9, LDM9, LPC_PH
    ...
    LPC_PH = PRESENT_AND_ACTIVE(PPC_PH)
    VARIABLE = VARIABLE_2RB(NAME, LACTIVE=.TRUE., LADV=.TRUE., LT1=LT1, LT9=LT9, LPH9=LPH9, LDL=LDL, LDM=LDM, &
                         & LDL9=LDL9, LDM9=LDM9, LPC_PH=LPC_PH)

    ! Associate FIELD objects with VARIABLE according to provided pointers
    IF (LT0) THEN
      CALL FIELD_NEW (VARIABLE%FT0, DATA=GMV(:,PT0,:))
    ELSE
      VARIABLE%FT0 => NULL ()
    ENDIF
    IF (LT1) THEN
      CALL FIELD_NEW (VARIABLE%FT1, DATA=GMVT1(:,PT1,:))
    ELSE
      VARIABLE%FT1 => NULL()
    END IF
    IF (LT9) THEN
      CALL FIELD_NEW (VARIABLE%FT9, DATA=GMV(:,PT9,:))
    ELSE
      VARIABLE%FT9 => NULL()
    END IF
    IF (LPH9) THEN
      CALL FIELD_NEW (VARIABLE%FPH9, DATA=GMV(:,PPH9,:))
    ELSE
      VARIABLE%FPH9 => NULL()
    END IF
    IF (LDL) THEN
      CALL FIELD_NEW (VARIABLE%FDL, DATA=GMV(:,PDL,:))
    ELSE
      VARIABLE%FDL => NULL()
    END IF
    IF (LDM) THEN
      CALL FIELD_NEW (VARIABLE%FDM, DATA=GMV(:,PDM,:))
    ELSE
      VARIABLE%FDM => NULL()
    END IF
    IF (LDL9) THEN
      CALL FIELD_NEW (VARIABLE%FDL9, DATA=GMV(:,PDL9,:))
    ELSE
      VARIABLE%FDL9 => NULL()
    END IF
    IF (LDM9) THEN
      CALL FIELD_NEW (VARIABLE%FDM9, DATA=GMV(:,PDM9,:))
    ELSE
      VARIABLE%FDM9 => NULL()
    END IF
    IF (LPC_PH) THEN
      CALL FIELD_NEW (VARIABLE%FPC_PH, DATA=GMVT1(:,PPC_PH,:))
    ELSE
      VARIABLE%FPC_PH => NULL()
    END IF
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_3RB_GMV(SELF, NAME, GMV, GMVT1, PT0, PT1, PT9, PPH9, PDL, PDM, &
   &                                             PDL9, PDM9, PPC_PH, PERSISTENT) RESULT(VARIABLE)
    ...
    LDM9 = PRESENT_AND_ACTIVE(PDM9)
    LPC_PH = PRESENT_AND_ACTIVE(PPC_PH)
    VARIABLE = VARIABLE_3RB(NAME, LACTIVE=.TRUE., LADV=.TRUE., LT1=LT1, LT9=LT9, LPH9=LPH9, &
                         & LDL=LDL, LDM=LDM, LDL9=LDL9, LDM9=LDM9, LPC_PH=LPC_PH)
  ...
  FUNCTION FIELD_REGISTRY_CREATE_VARIABLE_GFL(SELF, NAME, YDCOMP, GFL, PERSISTENT) RESULT(VARIABLE)
    ...
    VARIABLE = VARIABLE_3RB(NAME, CNAME=YDCOMP%CNAME, IGRBCODE=YDCOMP%IGRBCODE, LACTIVE=YDCOMP%LACTIVE, &
     &                     LADV=YDCOMP%LADV, LT1=YDCOMP%LT1, LT9=YDCOMP%LT9, LPH9=YDCOMP%LPHY, LPC_PH=YDCOMP%MPPC_PH>0, LGP=YDCOMP%LGP, LWATER=YDCOMP%LWATER,&
    ...
    IF (YDCOMP%LACTIVE .AND. YDCOMP%MP > 0) THEN
      CALL FIELD_NEW (VARIABLE%FT0, DATA=GFL%GFL(:,:,YDCOMP%MP,:))
    ELSE
      VARIABLE%FT0 => NULL()
    END IF
    IF (YDCOMP%LACTIVE .AND. YDCOMP%MP1 > 0) THEN
      CALL FIELD_NEW (VARIABLE%FT1, DATA=GFL%GFLT1(:,:,YDCOMP%MP1,:))
    ELSE
      VARIABLE%FT1 => NULL()
    END IF
    IF (YDCOMP%LACTIVE .AND. YDCOMP%MP9 > 0) THEN
      CALL FIELD_NEW (VARIABLE%FT9, DATA=GFL%GFL(:,:,YDCOMP%MP9,:))
    ELSE
      VARIABLE%FT9 => NULL()
    END IF
    IF (YDCOMP%LACTIVE .AND. YDCOMP%MP9_PH > 0) THEN
      CALL FIELD_NEW (VARIABLE%FPH9, DATA=GFL%GFL(:,:,YDCOMP%MP9_PH,:))
    ELSE
      VARIABLE%FPH9 => NULL()
    END IF
    IF (YDCOMP%LACTIVE .AND. YDCOMP%MPL > 0) THEN
      CALL FIELD_NEW (VARIABLE%FDL, DATA=GFL%GFL(:,:,YDCOMP%MPL,:))
    ELSE
      VARIABLE%FDL => NULL()
    END IF
    IF (YDCOMP%LACTIVE .AND. YDCOMP%MPM > 0) THEN
      CALL FIELD_NEW (VARIABLE%FDM, DATA=GFL%GFL(:,:,YDCOMP%MPM,:))
    ELSE
      VARIABLE%FDM => NULL()
    END IF
    IF (YDCOMP%LACTIVE .AND. YDCOMP%MPPC_PH > 0) THEN
      CALL FIELD_NEW (VARIABLE%FPC_PH, DATA=GFL%GFLT1(:,:,YDCOMP%MPPC_PH,:))
    ELSE
      VARIABLE%FPC_PH => NULL()
    END IF
  ...
  SUBROUTINE FIELD_REGISTRY_REGISTER_GEOMETRY(SELF, VARIABLES, GEOM)
    ...
    VARIABLES%GEOMETRY%RCOLON = SELF%FIELD_REGISTRY_CREATE_VARIABLE_WRAP_2RD (NAME='RCOLON', DATA=GEOM%YRCSGEOM_B%RCOLON)
    VARIABLES%GEOMETRY%RSILON = SELF%FIELD_REGISTRY_CREATE_VARIABLE_WRAP_2RD (NAME='RSILON', DATA=GEOM%YRCSGEOM_B%RSILON)
  ...
  SUBROUTINE FIELD_REGISTRY_REGISTER_GMV_FIELDS(SELF, VARIABLES, GMV)
    ...
    VARIABLES%PCF_U      = SELF%CREATE_VARIABLE('PCF_U'    , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_U  )
    VARIABLES%PCF_V      = SELF%CREATE_VARIABLE('PCF_V'    , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_V  )
    VARIABLES%PCF_T      = SELF%CREATE_VARIABLE('PCF_T'    , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_T  )
    VARIABLES%PCF_SPD    = SELF%CREATE_VARIABLE('PCF_SPD'  , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_SPD)
    VARIABLES%PCF_SVD    = SELF%CREATE_VARIABLE('PCF_SVD'  , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_SVD)
    VARIABLES%PCF_NHX    = SELF%CREATE_VARIABLE('PCF_NHX'  , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_NHX)
    VARIABLES%PCF_SP     = SELF%CREATE_VARIABLE('PCF_SP'   , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_SP )
    VARIABLES%PCF_CP     = SELF%CREATE_VARIABLE('PCF_CP'   , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_CP )
    VARIABLES%PCF_UP     = SELF%CREATE_VARIABLE('PCF_UP'   , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_UP )
    VARIABLES%PCF_VP     = SELF%CREATE_VARIABLE('PCF_VP'   , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_VP )
    VARIABLES%PCF_TP     = SELF%CREATE_VARIABLE('PCF_TP'   , GMV%GMV, GMVT1, PPC_PH=YT1%MGPPCF_TP )
    ...
    VARIABLES%PCF_BBC  = SELF%CREATE_VARIABLE('PCF_BBC'  ,  GMVS, GMVT1S, PPC_PH=YT1%MGPPCF_BBC )
    VARIABLES%PCF_DPHI = SELF%CREATE_VARIABLE('PCF_DPHI' ,  GMVS, GMVT1S, PPC_PH=YT1%MGPPCF_DPHI)
    VARIABLES%PCF_GWS  = SELF%CREATE_VARIABLE('PCF_GWS'  ,  GMVS, GMVT1S, PPC_PH=YT1%MGPPCF_GWS )
  ...
  SUBROUTINE FIELD_REGISTRY_REGISTER_GFL_FIELDS(SELF, VARIABLES, GFL_ARRAY, GFL_META, YDMODEL)
    ...
    VARIABLES%IMF = SELF%CREATE_VARIABLE('IMF', GFL_META%YIMF, GFL_ARRAY)
    VARIABLES%LMF = SELF%CREATE_VARIABLE('LMF', GFL_META%YLMF, GFL_ARRAY)
    ...
    VARIABLES%AMF = SELF%CREATE_VARIABLE('AMF', GFL_META%YAMF, GFL_ARRAY)
    ...
    VARIABLES%GHG = SELF%CREATE_VARIABLE('GHG', GFL_META%YGHG, GFL_ARRAY)
    VARIABLES%CHEM = SELF%CREATE_VARIABLE('CHEM', GFL_META%YCHEM, GFL_ARRAY)
    VARIABLES%AERO = SELF%CREATE_VARIABLE('AERO', GFL_META%YAERO, GFL_ARRAY)
    VARIABLES%LRCH4 = SELF%CREATE_VARIABLE('LRCH4', GFL_META%YLRCH4, GFL_ARRAY)
    VARIABLES%FORC = SELF%CREATE_VARIABLE('FORC', GFL_META%YFORC, GFL_ARRAY)
    VARIABLES%EZDIAG = SELF%CREATE_VARIABLE('EZDIAG', GFL_META%YEZDIAG, GFL_ARRAY)
    VARIABLES%ERA40 = SELF%CREATE_VARIABLE('ERA40', GFL_META%YERA40, GFL_ARRAY)
    VARIABLES%NOGW = SELF%CREATE_VARIABLE('NOGW', GFL_META%YNOGW, GFL_ARRAY)
    VARIABLES%EMIS3D = SELF%CREATE_VARIABLE('EMIS3D', GFL_META%YEMIS3D, GFL_ARRAY)
    VARIABLES%EDRP = SELF%CREATE_VARIABLE('EDRP', GFL_META%YEDRP, GFL_ARRAY)
    VARIABLES%SLDIA = SELF%CREATE_VARIABLE('SLDIA', GFL_META%YSLDIA, GFL_ARRAY)
    VARIABLES%AERAOT = SELF%CREATE_VARIABLE('AERAOT', GFL_META%YAERAOT, GFL_ARRAY)
    VARIABLES%AERLISI = SELF%CREATE_VARIABLE('AERLISI', GFL_META%YAERLISI, GFL_ARRAY)
    VARIABLES%AEROUT = SELF%CREATE_VARIABLE('AEROUT', GFL_META%YAEROUT, GFL_ARRAY)
    VARIABLES%AEROCLIM = SELF%CREATE_VARIABLE('AEROCLIM', GFL_META%YAEROCLIM, GFL_ARRAY)
    VARIABLES%UVP = SELF%CREATE_VARIABLE('UVP', GFL_META%YUVP, GFL_ARRAY)
    ...
    VARIABLES%LIMA = SELF%CREATE_VARIABLE('LIMA', GFL_META%YLIMA, GFL_ARRAY)
    VARIABLES%FSD = SELF%CREATE_VARIABLE('FSD', GFL_META%YFSD, GFL_ARRAY)
    VARIABLES%EXT = SELF%CREATE_VARIABLE('EXT', GFL_META%YEXT, GFL_ARRAY)
    ...
    ISIZE = ISIZE + 1
    ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%GHG)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%CHEM)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERO)
      ISIZE = ISIZE + 1
    ENDDO
    ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%FORC)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EZDIAG)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%ERA40)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%NOGW)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EMIS3D)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EDRP)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%SLDIA)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERAOT)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERLISI)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROUT)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROCLIM)
      ISIZE = ISIZE + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%UVP)
      ISIZE = ISIZE + 1
    ENDDO
    ISIZE = ISIZE + 1
    ISIZE = ISIZE + 1
    ...
    ISIZE = ISIZE + 1
    ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%LIMA)
      ISIZE = ISIZE + 1
    ENDDO
    ISIZE = ISIZE + 1
    DO JFLD = 1, SIZE (VARIABLES%EXT)
      ISIZE = ISIZE + 1
    ENDDO

   ALLOCATE (VARIABLES%GFL_PTR (ISIZE))

   IPNTR = 1

    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%Q
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%I
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%L
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%IMF
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%LMF
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%LCONV
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%ICONV
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%RCONV
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%SCONV
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%IRAD
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%LRAD
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%S
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%R
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%G
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%H
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%TKE
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%TTE
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%EFB1
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%EFB2
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%EFB3
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%A
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%AMF
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%O3
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%SRC
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%MXL
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%SHTUR
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%FQTUR
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%FSTUR
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%CPF
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%SPF
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%CVGQ
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%QVA
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (VARIABLES%GHG)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%GHG(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%CHEM)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%CHEM(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERO)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%AERO(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%LRCH4
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (VARIABLES%FORC)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%FORC(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EZDIAG)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%EZDIAG(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%ERA40)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%ERA40(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%NOGW)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%NOGW(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EMIS3D)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%EMIS3D(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%EDRP)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%EDRP(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%SLDIA)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%SLDIA(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERAOT)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%AERAOT(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AERLISI)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%AERLISI(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROUT)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%AEROUT(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%AEROCLIM)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%AEROCLIM(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    DO JFLD = 1, SIZE (VARIABLES%UVP)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%UVP(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%PHYCTY
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%RSPEC
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%SDSAT
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%CVV
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%RKTH
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%RKTQV
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%RKTQC
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%UOM
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%UAL
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%DOM
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%DAL
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%UEN
    IPNTR = IPNTR + 1
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%UNEBH
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (VARIABLES%LIMA)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%LIMA(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
    VARIABLES%GFL_PTR (IPNTR) = VARIABLES%FSD
    IPNTR = IPNTR + 1
    DO JFLD = 1, SIZE (VARIABLES%EXT)
      VARIABLES%GFL_PTR (IPNTR) = VARIABLES%EXT(JFLD)
      IPNTR = IPNTR + 1
    ENDDO
  ...
  SUBROUTINE FIELD_REGISTRY_CREATE_SURFACE_VARIABLE_2RB(SELF, NAME, VARIABLE, ARRAY, META, DESCR, ACTIVE, PERSISTENT)
    ...
    ASSOCIATE (NPROMA => SELF%GEOM%YRDIM%NPROMA, NFLEVG => SELF%GEOM%YRDIMV%NFLEVG, NGPBLKS => SELF%GEOM%YRDIM%NGPBLKS)

    IF (.NOT. ACTIVE) THEN
      ! For inactive variables we still create full-sized temporaries,
      ! since the SURF module expects full NPROMA-sized buffers.
      VARIABLE = VARIABLE_2RB(NAME, LACTIVE=.FALSE., LT1=.FALSE., LT9=.FALSE.)
      CALL FIELD_NEW (VARIABLE%FT0, [NPROMA, NGPBLKS], PERSISTENT=PERSISTENT)
      CALL FIELD_NEW (VARIABLE%FT1, [NPROMA, NGPBLKS], PERSISTENT=PERSISTENT)
      CALL FIELD_NEW (VARIABLE%FT9, [NPROMA, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      ! Create variable according to existing meta-data
      VARIABLE = VARIABLE_2RB(NAME, LACTIVE=META%MP > 0, LT1=META%MP1 > 0, LT9=META%MP9 > 0)

      IF (META%MP > 0) THEN
        CALL FIELD_NEW (VARIABLE%FT0, DATA=ARRAY(:,META%MP,:))
      ELSE
        CALL FIELD_NEW (VARIABLE%FT0, [NPROMA, NGPBLKS], PERSISTENT=PERSISTENT)
      END IF
      IF (META%MP1 > 0) THEN
        CALL FIELD_NEW (VARIABLE%FT1, DATA=ARRAY(:,META%MP1,:))
      ELSE
        CALL FIELD_NEW (VARIABLE%FT1, [NPROMA, NGPBLKS], PERSISTENT=PERSISTENT)
      END IF
      IF (META%MP9 > 0) THEN
        CALL FIELD_NEW (VARIABLE%FT9, DATA=ARRAY(:,META%MP9,:))
      ELSE
        CALL FIELD_NEW (VARIABLE%FT9, [NPROMA, NGPBLKS], PERSISTENT=PERSISTENT)
      END IF
    END IF
  ...
  SUBROUTINE FIELD_REGISTRY_CREATE_SURFACE_VARIABLE_ARRAY_2RB(SELF, NAME, VARIABLES, ARRAY, META, DESCR, ACTIVE, PERSISTENT)
    ...
    DO I=1, SIZE(META)
      VNAME = NAME//"_"//CHAR(I)
      CALL SELF%CREATE_SURFACE_VARIABLE_2RB(VNAME, VARIABLES(I), ARRAY, META(I), DESCR, ACTIVE, PERSISTENT)
    END DO
  ...
  SUBROUTINE FIELD_REGISTRY_CREATE_SURFACE_VARIABLE_ARRAY2_2RB(SELF, NAME, VARIABLES, ARRAY, META, DESCR, ACTIVE, PERSISTENT)
    ...
    DO J=1, SIZE(META, DIM=2)
      DO I=1, SIZE(META, DIM=1)
        ...
        CALL SELF%CREATE_SURFACE_VARIABLE_2RB(VNAME, VARIABLES(I,J), ARRAY, META(I,J), DESCR, ACTIVE, PERSISTENT)
      END DO
    END DO
  ...
  SUBROUTINE FIELD_REGISTRY_CREATE_SURFACE_VARIABLE_3RB(SELF, NAME, VARIABLE, ARRAY, META, DESCR, ACTIVE, PERSISTENT)
    ...
    IF (.NOT. ACTIVE) THEN
      ! For inactive variables we still create full-sized temporaries,
      ! since the SURF module expects full NPROMA-sized buffers.
      VARIABLE = VARIABLE_3RB(NAME, LACTIVE=.FALSE., LT1=.FALSE., LT9=.FALSE.)
      CALL FIELD_NEW (VARIABLE%FT0, UBOUNDS=[NPROMA, DESCR%NLEVS, NGPBLKS], PERSISTENT=PERSISTENT)
      CALL FIELD_NEW (VARIABLE%FT1, UBOUNDS=[NPROMA, DESCR%NLEVS, NGPBLKS], PERSISTENT=PERSISTENT)
      CALL FIELD_NEW (VARIABLE%FT9, UBOUNDS=[NPROMA, DESCR%NLEVS, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      ! Create variable according to existing meta-data
      VARIABLE = VARIABLE_3RB(NAME, LACTIVE=META%MP > 0, LT1=META%MP1 > 0, LT9=META%MP9 > 0)

      IF (META%MP > 0) THEN
        CALL FIELD_NEW (VARIABLE%FT0, DATA=ARRAY(:,:,META%MP,:))
      ELSE
        CALL FIELD_NEW (VARIABLE%FT0, [NPROMA, DESCR%NLEVS, NGPBLKS], PERSISTENT=PERSISTENT)
      END IF
      IF (META%MP1 > 0) THEN
        CALL FIELD_NEW (VARIABLE%FT1, DATA=ARRAY(:,:,META%MP1,:))
      ELSE
        CALL FIELD_NEW (VARIABLE%FT1, [NPROMA, DESCR%NLEVS, NGPBLKS], PERSISTENT=PERSISTENT)
      END IF
      IF (META%MP9 > 0) THEN
        CALL FIELD_NEW (VARIABLE%FT9, DATA=ARRAY(:,:,META%MP9,:))
      ELSE
        CALL FIELD_NEW (VARIABLE%FT9, [NPROMA, DESCR%NLEVS, NGPBLKS], PERSISTENT=PERSISTENT)
      END IF
    END IF
  ...
  SUBROUTINE FIELD_REGISTRY_CREATE_SURFACE_VARIABLE_ARRAY_3RB(SELF, NAME, VARIABLES, ARRAY, META, DESCR, ACTIVE, PERSISTENT)
    ...
    DO I=1, SIZE(META)
      VNAME = NAME//"_"//CHAR(I)
      CALL SELF%CREATE_SURFACE_VARIABLE_3RB(VNAME, VARIABLES(I), ARRAY, META(I), DESCR, ACTIVE, PERSISTENT)
    END DO
  ...
  SUBROUTINE FIELD_REGISTRY_CREATE_SURFACE_VARIABLE_ARRAY2_3RB(SELF, NAME, VARIABLES, ARRAY, META, DESCR, ACTIVE, PERSISTENT)
    ...
    DO J=1, SIZE(META, DIM=2)
      DO I=1, SIZE(META, DIM=1)
        VNAME = NAME//"_"//CHAR(I)//"_"//CHAR(J)
        CALL SELF%CREATE_SURFACE_VARIABLE_3RB(VNAME, VARIABLES(I,J), ARRAY, META(I,J), DESCR, ACTIVE, PERSISTENT)
      END DO
    END DO
  ...
  SUBROUTINE FIELD_REGISTRY_REGISTER_SURFACE_FIELDS(SELF, SURFVARS, YDSURF, PERSISTENT)
    ...
    IF (YSP_SBD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_SB%F_GROUP, [NPROMA, MAX(1,YSP_SBD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_SB%F_GROUP, DATA=SP_SB)
    END IF
    ...
    IF (YSP_SGD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_SG%F_GROUP, [NPROMA, MAX(1,YSP_SGD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_SG%F_GROUP, DATA=SP_SG)
    END IF
    ...
    IF (YSP_SLD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_SL%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_SL%F_GROUP, DATA=SP_SL)
    END IF
    ...
    IF (YSP_RRD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_RR%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_RR%F_GROUP, DATA=SP_RR)
    END IF
    ...
    IF (YSP_CLD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_CL%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_CL%F_GROUP, DATA=SP_CL)
    END IF
    ...
    IF (YSP_OMD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_OM%F_GROUP, [NPROMA, MAX(1,YSP_OMD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_OM%F_GROUP, DATA=SP_OM)
    END IF
    ...
    IF (YSP_EPD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_EP%F_GROUP, [NPROMA, MAX(1,YSP_EPD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_EP%F_GROUP, DATA=SP_EP)
    END IF
    ...
    IF (YSP_X2D%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_X2%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_X2%F_GROUP, DATA=SP_X2)
    END IF
    ...
    IF (YSP_CID%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSP_CI%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSP_CI%F_GROUP, DATA=SP_CI)
    END IF
    ...
    IF (ASSOCIATED(YSD_VF%YCHEMFLXO)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VF_CHEMFLXO', &
       & VARIABLES=SURFVARS%GSD_VF%VCHEMFLXO, ARRAY=SD_VF, &
       & META=YSD_VF%YCHEMFLXO(:), DESCR=YSD_VFD, &
       & ACTIVE=ASSOCIATED(YSD_VF%YCHEMFLXO))
    END IF
    IF (ASSOCIATED(YSD_VF%YCHEMWDFLX)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VF_CHEMWDFLX', &
       & VARIABLES=SURFVARS%GSD_VF%VCHEMWDFLX, ARRAY=SD_VF, &
       & META=YSD_VF%YCHEMWDFLX(:), DESCR=YSD_VFD, &
       & ACTIVE=ASSOCIATED(YSD_VF%YCHEMWDFLX))
    END IF
    IF (ASSOCIATED(YSD_VF%YCHEMDDFLX)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VF_CHEMDDFLX', &
       & VARIABLES=SURFVARS%GSD_VF%VCHEMDDFLX, ARRAY=SD_VF, &
       & META=YSD_VF%YCHEMDDFLX(:), DESCR=YSD_VFD, &
       & ACTIVE=ASSOCIATED(YSD_VF%YCHEMDDFLX))
    END IF
    IF (ASSOCIATED(YSD_VF%YCHEMDV)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VF_CHEMDV', &
       & VARIABLES=SURFVARS%GSD_VF%VCHEMDV, ARRAY=SD_VF, &
       & META=YSD_VF%YCHEMDV(:), DESCR=YSD_VFD, &
       & ACTIVE=ASSOCIATED(YSD_VF%YCHEMDV))
    END IF
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VF_NUDM', &
     & VARIABLE=SURFVARS%GSD_VF%VNUDM, ARRAY=SD_VF, &
     & META=YSD_VF%YNUDM, DESCR=YSD_VFD, &
     & ACTIVE=ASSOCIATED(YSD_VF%YNUDM))
    IF (ASSOCIATED(YSD_VF%YEMIS2D)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VF_EMIS2D', &
       & VARIABLES=SURFVARS%GSD_VF%VEMIS2D, ARRAY=SD_VF, &
       & META=YSD_VF%YEMIS2D(:), DESCR=YSD_VFD, &
       & ACTIVE=ASSOCIATED(YSD_VF%YEMIS2D))
    END IF
    IF (ASSOCIATED(YSD_VF%YEMIS2DAUX)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VF_EMIS2DAUX', &
       & VARIABLES=SURFVARS%GSD_VF%VEMIS2DAUX, ARRAY=SD_VF, &
       & META=YSD_VF%YEMIS2DAUX(:), DESCR=YSD_VFD, &
       & ACTIVE=ASSOCIATED(YSD_VF%YEMIS2DAUX))
    END IF

    ASSOCIATE (NPROMA => SELF%GEOM%YRDIM%NPROMA, NFLEVG => SELF%GEOM%YRDIMV%NFLEVG, NGPBLKS => SELF%GEOM%YRDIM%NGPBLKS)
    IF (YSD_VFD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_VF%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_VF%F_GROUP, DATA=SD_VF)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_VH=>YDSURF%SD_VH, YSD_VH=>YDSURF%YSD_VH, YSD_VHD=>YDSURF%YSD_VHD)
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_TCCH', &
     & VARIABLE=SURFVARS%GSD_VH%VTCCH, ARRAY=SD_VH, &
     & META=YSD_VH%YTCCH, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YTCCH))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_SCCH', &
     & VARIABLE=SURFVARS%GSD_VH%VSCCH, ARRAY=SD_VH, &
     & META=YSD_VH%YSCCH, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YSCCH))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_BCCH', &
     & VARIABLE=SURFVARS%GSD_VH%VBCCH, ARRAY=SD_VH, &
     & META=YSD_VH%YBCCH, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YBCCH))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_PBLH', &
     & VARIABLE=SURFVARS%GSD_VH%VPBLH, ARRAY=SD_VH, &
     & META=YSD_VH%YPBLH, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YPBLH))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_SPSH', &
     & VARIABLE=SURFVARS%GSD_VH%VSPSH, ARRAY=SD_VH, &
     & META=YSD_VH%YSPSH, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YSPSH))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_QSH', &
     & VARIABLE=SURFVARS%GSD_VH%VQSH, ARRAY=SD_VH, &
     & META=YSD_VH%YQSH, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YQSH))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_PCL', &
     & VARIABLE=SURFVARS%GSD_VH%VPCL, ARRAY=SD_VH, &
     & META=YSD_VH%YPCL, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YPCL))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_PSL', &
     & VARIABLE=SURFVARS%GSD_VH%VPSL, ARRAY=SD_VH, &
     & META=YSD_VH%YPSL, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YPSL))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_PCN', &
     & VARIABLE=SURFVARS%GSD_VH%VPCN, ARRAY=SD_VH, &
     & META=YSD_VH%YPCN, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YPCN))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_PSN', &
     & VARIABLE=SURFVARS%GSD_VH%VPSN, ARRAY=SD_VH, &
     & META=YSD_VH%YPSN, DESCR=YSD_VHD, &
     & ACTIVE=ASSOCIATED(YSD_VH%YPSN))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VH_EVA', &
    ...
    IF (YSD_VHD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_VH%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_VH%F_GROUP, DATA=SD_VH)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_VK=>YDSURF%SD_VK, YSD_VK=>YDSURF%YSD_VK, YSD_VKD=>YDSURF%YSD_VKD)
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VK_UDGRO', &
    ...
    IF (YSD_VKD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_VK%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_VK%F_GROUP, DATA=SD_VK)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_VP=>YDSURF%SD_VP, YSD_VP=>YDSURF%YSD_VP, YSD_VPD=>YDSURF%YSD_VPD)
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VP_TPC', &
     & VARIABLE=SURFVARS%GSD_VP%VTPC, ARRAY=SD_VP, &
     & META=YSD_VP%YTPC, DESCR=YSD_VPD, &
     & ACTIVE=ASSOCIATED(YSD_VP%YTPC))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VP_WPC', &
    ...
    IF (YSD_VND%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_VN%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_VN%F_GROUP, DATA=SD_VN)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_V2=>YDSURF%SD_V2, YSD_V2=>YDSURF%YSD_V2, YSD_V2D=>YDSURF%YSD_V2D)
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_V2_OCDEP', &
     & VARIABLE=SURFVARS%GSD_V2%VOCDEP, ARRAY=SD_V2, &
     & META=YSD_V2%YOCDEP, DESCR=YSD_V2D, &
     & ACTIVE=ASSOCIATED(YSD_V2%YOCDEP))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_V2_USTRC', &
     & VARIABLE=SURFVARS%GSD_V2%VUSTRC, ARRAY=SD_V2, &
     & META=YSD_V2%YUSTRC, DESCR=YSD_V2D, &
     & ACTIVE=ASSOCIATED(YSD_V2%YUSTRC))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_V2_VSTRC', &
    ...
    IF (ASSOCIATED(YSD_VD%YMX2T6)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VD_MX2T6', &
    ...
    IF (ASSOCIATED(YSD_VD%YMXTPR6)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VD_MXTPR6', &
    ...
    IF (ASSOCIATED(YSD_VD%YMXCAP6)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VD_MXCAP6', &
    ...
    IF (ASSOCIATED(YSD_VD%YTCGHG)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VD_TCGHG', &
    ...
    IF (ASSOCIATED(YSD_VD%YTCCHEM)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VD_TCCHEM', &
    ...
    IF (ASSOCIATED(YSD_VD%YAERODIAG)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY2_2RB(NAME='SD_VD_AERODIAG', &
    ...
    IF (ASSOCIATED(YSD_VD%YAERO_WVL_DIAG)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY2_2RB(NAME='SD_VD_AERO_WVL_DIAG', &
    ...
    IF (ASSOCIATED(YSD_VD%YLITOTA6)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VD_LITOTA6', &
    ...
    IF (ASSOCIATED(YSD_VD%YLICGA6)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY_2RB(NAME='SD_VD_LICGA6', &
       & VARIABLES=SURFVARS%GSD_VD%VLICGA6, ARRAY=SD_VD, &
       & META=YSD_VD%YLICGA6(:), DESCR=YSD_VDD, &
       & ACTIVE=ASSOCIATED(YSD_VD%YLICGA6))
    END IF
    IF (ASSOCIATED(YSD_VD%YPTYPEOCC6)) THEN
      CALL SELF%CREATE_SURFACE_VARIABLE_ARRAY2_2RB(NAME='SD_VD_PTYPEOCC6', &
       & VARIABLES=SURFVARS%GSD_VD%VPTYPEOCC6, ARRAY=SD_VD, &
       & META=YSD_VD%YPTYPEOCC6(:,:), DESCR=YSD_VDD, &
       & ACTIVE=ASSOCIATED(YSD_VD%YPTYPEOCC6))
    END IF

    ASSOCIATE (NPROMA => SELF%GEOM%YRDIM%NPROMA, NFLEVG => SELF%GEOM%YRDIMV%NFLEVG, NGPBLKS => SELF%GEOM%YRDIM%NGPBLKS)
    IF (YSD_VDD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_VD%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_VD%F_GROUP, DATA=SD_VD)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_SM=>YDSURF%SD_SM, YSD_SM=>YDSURF%YSD_SM, YSD_SMD=>YDSURF%YSD_SMD)
    CALL SELF%CREATE_SURFACE_VARIABLE_3RB(NAME='SD_SM_CLBT', &
     & VARIABLE=SURFVARS%GSD_SM%VCLBT, ARRAY=SD_SM, &
     & META=YSD_SM%YCLBT, DESCR=YSD_SMD, &
     & ACTIVE=ASSOCIATED(YSD_SM%YCLBT))
    CALL SELF%CREATE_SURFACE_VARIABLE_3RB(NAME='SD_SM_CSBT', &
    ...
    IF (YSD_SMD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_SM%F_GROUP, [NPROMA, MAX(1,YSD_SMD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_SM%F_GROUP, DATA=SD_SM)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_WS=>YDSURF%SD_WS, YSD_WS=>YDSURF%YSD_WS, YSD_WSD=>YDSURF%YSD_WSD)
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_CHAR', &
     & VARIABLE=SURFVARS%GSD_WS%VCHAR, ARRAY=SD_WS, &
     & META=YSD_WS%YCHAR, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YCHAR))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_CHARHQ', &
     & VARIABLE=SURFVARS%GSD_WS%VCHARHQ, ARRAY=SD_WS, &
     & META=YSD_WS%YCHARHQ, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YCHARHQ))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_USTOKES', &
     & VARIABLE=SURFVARS%GSD_WS%VUSTOKES, ARRAY=SD_WS, &
     & META=YSD_WS%YUSTOKES, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YUSTOKES))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_VSTOKES', &
     & VARIABLE=SURFVARS%GSD_WS%VVSTOKES, ARRAY=SD_WS, &
     & META=YSD_WS%YVSTOKES, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YVSTOKES))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_TAUOCX', &
     & VARIABLE=SURFVARS%GSD_WS%VTAUOCX, ARRAY=SD_WS, &
     & META=YSD_WS%YTAUOCX, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YTAUOCX))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_TAUOCY', &
     & VARIABLE=SURFVARS%GSD_WS%VTAUOCY, ARRAY=SD_WS, &
     & META=YSD_WS%YTAUOCY, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YTAUOCY))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_PHIOC', &
     & VARIABLE=SURFVARS%GSD_WS%VPHIOC, ARRAY=SD_WS, &
     & META=YSD_WS%YPHIOC, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YPHIOC))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_WSEMEAN', &
     & VARIABLE=SURFVARS%GSD_WS%VWSEMEAN, ARRAY=SD_WS, &
     & META=YSD_WS%YWSEMEAN, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YWSEMEAN))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WS_WSFMEAN', &
     & VARIABLE=SURFVARS%GSD_WS%VWSFMEAN, ARRAY=SD_WS, &
     & META=YSD_WS%YWSFMEAN, DESCR=YSD_WSD, &
     & ACTIVE=ASSOCIATED(YSD_WS%YWSFMEAN))

    ASSOCIATE (NPROMA => SELF%GEOM%YRDIM%NPROMA, NFLEVG => SELF%GEOM%YRDIMV%NFLEVG, NGPBLKS => SELF%GEOM%YRDIM%NGPBLKS)
    IF (YSD_WSD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_WS%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_WS%F_GROUP, DATA=SD_WS)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_WW=>YDSURF%SD_WW, YSD_WW=>YDSURF%YSD_WW, YSD_WWD=>YDSURF%YSD_WWD)
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_U10N', &
     & VARIABLE=SURFVARS%GSD_WW%VU10N, ARRAY=SD_WW, &
     & META=YSD_WW%YU10N, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YU10N))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_V10N', &
     & VARIABLE=SURFVARS%GSD_WW%VV10N, ARRAY=SD_WW, &
     & META=YSD_WW%YV10N, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YV10N))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_RHO', &
     & VARIABLE=SURFVARS%GSD_WW%VRHO, ARRAY=SD_WW, &
     & META=YSD_WW%YRHO, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YRHO))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_ZIL', &
     & VARIABLE=SURFVARS%GSD_WW%VZIL, ARRAY=SD_WW, &
     & META=YSD_WW%YZIL, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YZIL))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_CIF', &
     & VARIABLE=SURFVARS%GSD_WW%VCIF, ARRAY=SD_WW, &
     & META=YSD_WW%YCIF, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YCIF))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_CLK', &
     & VARIABLE=SURFVARS%GSD_WW%VCLK, ARRAY=SD_WW, &
     & META=YSD_WW%YCLK, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YCLK))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_UCURW', &
     & VARIABLE=SURFVARS%GSD_WW%VUCURW, ARRAY=SD_WW, &
     & META=YSD_WW%YUCURW, DESCR=YSD_WWD, &
     & ACTIVE=ASSOCIATED(YSD_WW%YUCURW))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_WW_VCURW', &
    ...
    IF (YSD_WWD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_WW%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_WW%F_GROUP, DATA=SD_WW)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_PF=>YDSURF%SD_PF, YSD_PF=>YDSURF%YSD_PF, YSD_PFD=>YDSURF%YSD_PFD)

    ASSOCIATE (NPROMA => SELF%GEOM%YRDIM%NPROMA, NFLEVG => SELF%GEOM%YRDIMV%NFLEVG, NGPBLKS => SELF%GEOM%YRDIM%NGPBLKS)
    IF (YSD_PFD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_PF%F_GROUP, [NPROMA, MAX(1,YSD_PFD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_PF%F_GROUP, DATA=SD_PF)
    END IF
    ...
    IF (YSD_XAD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_XA%F_GROUP, [NPROMA, MAX(1,YSD_XAD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_XA%F_GROUP, DATA=SD_XA)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_DI=>YDSURF%SD_DI, YSD_DI=>YDSURF%YSD_DI, YSD_DID=>YDSURF%YSD_DID)
    CALL SELF%CREATE_SURFACE_VARIABLE_3RB(NAME='SD_DI_XEDR', &
    ...
    IF (YSD_DID%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_DI%F_GROUP, [NPROMA, MAX(1,YSD_DID%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_DI%F_GROUP, DATA=SD_DI)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_XP=>YDSURF%SD_XP, YSD_XP=>YDSURF%YSD_XP, YSD_XPD=>YDSURF%YSD_XPD)
    CALL SELF%CREATE_SURFACE_VARIABLE_3RB(NAME='SD_XP_PRECIP', &
    ...
    IF (YSD_XPD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_XP%F_GROUP, [NPROMA, MAX(1,YSD_XPD%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_XP%F_GROUP, DATA=SD_XP)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_XP2=>YDSURF%SD_XP2, YSD_XP2=>YDSURF%YSD_XP2, YSD_XP2D=>YDSURF%YSD_XP2D)
    CALL SELF%CREATE_SURFACE_VARIABLE_3RB(NAME='SD_XP2_PRECIP2', &
    ...
    IF (YSD_XP2D%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_XP2%F_GROUP, [NPROMA, MAX(1,YSD_XP2D%NLEVS), 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_XP2%F_GROUP, DATA=SD_XP2)
    END IF
    ...
    IF (YSD_X2D%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_X2%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_X2%F_GROUP, DATA=SD_X2)
    END IF
    ...
    IF (YSD_SFOD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_SFO%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_SFO%F_GROUP, DATA=SD_SFO)
    END IF
    ...
    IF (YSD_SFLD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_SFL%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_SFL%F_GROUP, DATA=SD_SFL)
    END IF

    END ASSOCIATE
    END ASSOCIATE
    ASSOCIATE(SD_VC=>YDSURF%SD_VC, YSD_VC=>YDSURF%YSD_VC, YSD_VCD=>YDSURF%YSD_VCD)
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VC_A', &
     & VARIABLE=SURFVARS%GSD_VC%VA, ARRAY=SD_VC, &
     & META=YSD_VC%YA, DESCR=YSD_VCD, &
     & ACTIVE=ASSOCIATED(YSD_VC%YA))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VC_B', &
     & VARIABLE=SURFVARS%GSD_VC%VB, ARRAY=SD_VC, &
     & META=YSD_VC%YB, DESCR=YSD_VCD, &
     & ACTIVE=ASSOCIATED(YSD_VC%YB))
    CALL SELF%CREATE_SURFACE_VARIABLE_2RB(NAME='SD_VC_C', &
    ...
    IF (YSD_VCD%NDIM == 0) THEN
      CALL FIELD_NEW (SURFVARS%GSD_VC%F_GROUP, [NPROMA, 1, NGPBLKS], PERSISTENT=PERSISTENT)
    ELSE
      CALL FIELD_NEW (SURFVARS%GSD_VC%F_GROUP, DATA=SD_VC)
    END IF
