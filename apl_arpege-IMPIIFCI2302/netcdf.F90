...
!
 module netcdf
  ...
  include "netcdf_externals.h"
  include "netcdf_overloads.h"
  include "netcdf_visibility.h"
contains
  include "netcdf_file.h"
  include "netcdf3_file.h"
  include "netcdf_dims.h"
  include "netcdf_attributes.h"
  include "netcdf_variables.h"
  include "netcdf_text_variables.h"
  include "netcdf_expanded.h"
  include "netcdf_eightbyte.h"
end module netcdf
