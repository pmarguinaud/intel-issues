...
CONTAINS
  ...
  PROCEDURE, PRIVATE :: CREATE_HOST_DATA => FIELD_2LM_CREATE_HOST_DATA
...
CONTAINS
  ...
  SUBROUTINE FIELD_2LM_WRAPPER_INIT(SELF, DATA, PERSISTENT, LBOUNDS, MAP_DEVPTR, SYNC_ON_FINAL)
...
END SUBROUTINE FIELD_2LM_WRAPPER_INIT
  ...
  SUBROUTINE FIELD_2LM_OWNER_INIT (SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, PINNED, MAP_DEVPTR)
USE FIELD_ABORT_MODULE
USE FIELD_2LM_DATA_MODULE, ONLY : FIELD_2LM_COPY_FUNC
...
END SUBROUTINE FIELD_2LM_OWNER_INIT
  ...
  SUBROUTINE FIELD_2LM_CREATE_HOST_DATA (SELF)

CLASS(FIELD_2LM_OWNER) :: SELF


END SUBROUTINE FIELD_2LM_CREATE_HOST_DATA
