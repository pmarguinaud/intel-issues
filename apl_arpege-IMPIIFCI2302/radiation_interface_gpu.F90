...
module radiation_interface_GPU
...
contains
  ...
  subroutine setup_radiation_GPU(yderdi,config, lacc)
use parkind1
use yomhook
use radiation_io
...
end subroutine setup_radiation_GPU

  subroutine set_gas_units_GPU(config, gas, lacc)
use radiation_config
use radiation_gas
use radiation_monochromatic
use radiation_ifs_rrtm
...
end subroutine set_gas_units_GPU

  subroutine radiation_GPU(ncol, nlev, istartcol, iendcol, config, &
&  single_level, thermodynamics, gas, cloud, aerosol, flux, lacc)
use parkind1
use yomhook
use radiation_io
use radiation_config
...
end subroutine radiation_GPU

  subroutine radiation_reverse_GPU(ncol, nlev, istartcol, iendcol, config, &
&  single_level, thermodynamics, gas, cloud, aerosol, flux, lacc)
use parkind1
use radiation_io
use radiation_config
...
end subroutine radiation_reverse_GPU

end module radiation_interface_GPU
