...
TYPE, EXTENDS (FIELD_3RD_WRAPPER) :: FIELD_3RD_WRAPPER_HELPER
  CLASS (FIELD_BASIC), POINTER :: PARENT => NULL ()
CONTAINS
  PROCEDURE :: DELETE_DEVICE_DATA => FIELD_3RD_DELETE_DEVICE_DATA_WRAPPER_HELPER
  PROCEDURE :: CREATE_DEVICE_DATA => FIELD_3RD_CREATE_DEVICE_DATA_WRAPPER_HELPER
  PROCEDURE :: SET_DEVICE_DIRTY => FIELD_3RD_SET_DEVICE_DIRTY_DATA_WRAPPER_HELPER
  PROCEDURE :: GET_DEVICE_DATA => FIELD_3RD_GET_DEVICE_DATA_WRAPPER_HELPER
  PROCEDURE :: GET_HOST_DATA => FIELD_3RD_GET_HOST_DATA_WRAPPER_HELPER
END TYPE

TYPE FIELD_3RD_WRAPPER_HELPER_PTR
  CLASS (FIELD_3RD_WRAPPER_HELPER), POINTER :: PTR => NULL ()
END TYPE


TYPE, EXTENDS (FIELD_4RD_WRAPPER) :: FIELD_4RD_GANG_WRAPPER
  TYPE (FIELD_3RD_WRAPPER_HELPER_PTR), POINTER :: CHILDREN (:) => NULL ()
CONTAINS
...
CONTAINS
  ...
  SUBROUTINE FIELD_3RD_CREATE_DEVICE_DATA_WRAPPER_HELPER (SELF)
CLASS(FIELD_3RD_WRAPPER_HELPER) :: SELF

END SUBROUTINE

  SUBROUTINE FIELD_3RD_DELETE_DEVICE_DATA_WRAPPER_HELPER (SELF)
CLASS(FIELD_3RD_WRAPPER_HELPER) :: SELF

END SUBROUTINE

  SUBROUTINE FIELD_3RD_SET_DEVICE_DIRTY_DATA_WRAPPER_HELPER (SELF)
CLASS (FIELD_3RD_WRAPPER_HELPER) :: SELF

END SUBROUTINE 

  SUBROUTINE FIELD_3RD_GET_HOST_DATA_WRAPPER_HELPER (SELF, MODE, PTR, QUEUE)
CLASS(FIELD_3RD_WRAPPER_HELPER) :: SELF
...
END SUBROUTINE 
  ...
  SUBROUTINE FIELD_3RD_GET_DEVICE_DATA_WRAPPER_HELPER (SELF, MODE, PTR, QUEUE)
CLASS(FIELD_3RD_WRAPPER_HELPER) :: SELF
INTEGER (KIND=JPIM),           INTENT(IN)    :: MODE
REAL(KIND=JPRD), POINTER,         INTENT(INOUT) :: PTR(:,:,:)
INTEGER (KIND=JPIM), OPTIONAL, INTENT(IN)    :: QUEUE
...
END SUBROUTINE 
  ...
  SUBROUTINE FIELD_4RD_GANG_WRAPPER_INIT(SELF, DATA, PERSISTENT, LBOUNDS, MAP_DEVPTR, SYNC_ON_FINAL)
...
END SUBROUTINE FIELD_4RD_GANG_WRAPPER_INIT
  ...
  SUBROUTINE FIELD_4RD_GANG_OWNER_INIT(SELF, LBOUNDS, UBOUNDS, PERSISTENT, DELAYED, INIT_VALUE, PINNED, MAP_DEVPTR)
