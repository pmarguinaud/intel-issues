...
contains
  ...
  subroutine solver_mcica_lw_GPU(nlev,istartcol,iendcol, &
...
end subroutine solver_mcica_lw_GPU

  subroutine solver_mcica_lw_CPU(nlev,istartcol,iendcol, &
&  config, single_level, cloud, &
&  od, ssa, g, od_cloud, ssa_cloud, g_cloud, planck_hl, &
&  emission, albedo, &
&  flux)
...
end subroutine solver_mcica_lw_CPU
